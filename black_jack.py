...
class Deck:
    def __init__(self):
        ...
        for shape in suites:
            for rank in ranks:
                self.cards.append(Card(shape, rank))
...
class Hand:
    ...
    def display(self, show_all_dealer_cards = False):
        print("Dealer hand" if self.dealer else "Your hand")
    ...
    def check_winner(self,player_hand, dealer_hand, game_over = False ): 
                if not game_over:
                    if player_hand.get_value() > 21:
                        ...
                        print("Both have black jack");
                        return True
                    elif player_hand.is_blackjack():
                        print("You have black jack you wins");
                        return True
                    elif dealer_hand.is_blackjack():
                        print("Dealer have black jack dealer wins");
                        return True
                else:
...
# print(hand.is_blackjack(), hand.display())